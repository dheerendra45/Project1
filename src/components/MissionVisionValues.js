        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {sections.map((section, index) => (
            ...
            >
              ...
              <motion.h3 
                className="text-xl md:text-2xl font-semibold text-center mb-4 md:mb-5 text-black-800"
                whileHover={{
                  scale: 1.1,
                  color: "#f97316",
                  transition: { duration: 0.3 }
              ...
              <p className="font-normal text-sm md:text-base text-center leading-relaxed flex-grow px-2 md:px-0"
