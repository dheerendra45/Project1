        ...
        <div className="flex flex-col lg:flex-row justify-between gap-8">
          ...
          >
            ...
            <div className="border-2 border-dashed border-orange-500 p-4 bg-orange-50">
              <div className="text-sm text-gray-600 mb-1">FEEL FREE TO CALL US</div>
              <div className="text-xl font-bold text-black">+91 33 4017 5000</div>
          ...
          >
            ...
            <ul className="space-y-2 sm:space-y-4">
              <li><Link to="/about" className="text-black hover:text-orange-500 text-sm sm:text-base">About Us</Link></li>
              <li><Link to="/careers" className="text-black hover:text-orange-500 text-sm sm:text-base">Careers</Link></li>
              <li><Link to="/privacy" className="text-black hover:text-orange-500 text-sm sm:text-base">Privacy Policy</Link></li>
              <li><Link to="/pricing" className="text-black hover:text-orange-500 text-sm sm:text-base">Pricing</Link></li>
              <li><Link to="/products" className="text-black hover:text-orange-500 text-sm sm:text-base">Products</Link></li>
              <li><Link to="/blog" className="text-black hover:text-orange-500 text-sm sm:text-base">Contact</Link></li>
            </ul>
          </motion.div>
          ...
          >
            ...
            <ul className="space-y-2 sm:space-y-4">
              <li><Link to="/achievement" className="text-black hover:text-orange-500 text-sm sm:text-base">Achievement</Link></li>
              <li><Link to="/blog" className="text-black hover:text-orange-500 text-sm sm:text-base">Blog</Link></li>
              <li><Link to="/services" className="text-black hover:text-orange-500 text-sm sm:text-base">Services</Link></li>
              <li><Link to="/LeadershipPage" className="text-black hover:text-orange-500 text-sm sm:text-base">Team</Link></li>
              <li><Link to="/faq-page" className="text-black hover:text-orange-500 text-sm sm:text-base">Faq</Link></li>
              <li><Link to="/terms" className="text-black hover:text-orange-500 text-sm sm:text-base">Terms of use</Link></li>
            </ul>
          </motion.div>
    ...
    <path d="M20.93 3.09h-2.18l-4.69 6.05L9.64 3.09H3.27L9.67 12 3 20.91h2.18l5.03-6.49 4.69 6.49h6.37l-6.69-8.92z" />
        ...
        <div className="border-t border-gray-200 mt-8 pt-8 text-center">
          <p className="text-gray-600 text-sm">
            Copyright 2025 Shyam Theme by <Link to="/" className="text-orange-500 hover:text-orange-600">Shyam</Link> | All Rights Reserved
          </p>
        </div>
      </div>
    </footer>
