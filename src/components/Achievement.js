      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-start justify-between gap-12">
        ...
        <div className="lg:w-[40%] text-center lg:text-left">
          <p className="text-orange-500 text-paragraph-style text-sm leading-relaxed max-w-md mx-auto lg:mx-0 text-center mt-[9%] ml-[10%]">
            ...
            outcome. Our dedication to sustainable growth, employee well-being,
            innovation, and industry leadership has been recognized by premier
            national and international forums. Each award, certification, and
            endorsement stands as a testament to the trust we’ve built and the
