...
const Certificates = () => {
  ...
  const certificates = [
    ...
    { id: 2, title: "ISO 14001:2015 (Environmental)" },
    { id: 3, title: "CE Marking (EN 1090) for EU exports" },
    { id: 4, title: "BIS Certification (IS 2062)" },
    { id: 5, title: "IATF 16949 (For automotive-grade steel)" },
  ];
