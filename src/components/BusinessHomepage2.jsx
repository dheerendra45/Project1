  ...
  return (
    <div className="bg-[#EDF1F4] py-8 sm:py-12 px-4 sm:px-5 md:px-6 lg:px-8 font-sans">
      <div className="max-w-7xl mx-auto">
        {/* Heading with same padding as cards */}
        <div className="px-4 sm:px-5 md:px-6 lg:px-8 mb-6 sm:mb-8">
          <h2 className="text-gray-800 text-2xl sm:text-3xl lg:text-4xl font-semibold">
            Our Portfolio
          </h2>
        </div>

        <div ref={containerRef}>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 px-4 sm:px-5 md:px-6 lg:px-8">
          ...
          <div className="flex justify-center mt-8 sm:mt-12 mb-4 px-4 sm:px-5 md:px-6 lg:px-8">
