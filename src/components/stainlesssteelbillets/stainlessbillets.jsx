        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          >
            <div className="flex items-center mb-8">
              <h2 className="text-4xl font-bold text-gray-900">  Stainless Steel Billets</h2>
            ...
            <motion.p
              ...
              variants={fadeInUp}
            >
              Shyam Metalics manufactures high-quality stainless steel billets using advanced Electric Arc Furnace (EAF) and continuous casting technology. These billets serve as essential raw materials for manufacturing bars, rods, wires, and precision-engineered components across various industrial sectors.
              <br /><br />
              As a trusted supplier in the steel industry, we offer competitive stainless steel billet prices while ensuring uncompromised quality and timely delivery.
            </motion.p>
