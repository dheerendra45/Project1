...
const IndustrialCards = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-300 py-12 px-5">
      <h2 className="text-gray-800 text-4xl font-bold ml-7 mb-8">Business Areas</h2>
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-wrap justify-center gap-8">
          {cardsData.map((card) => (
            ...
            >
              ...
              {/* Gradient Overlay */}
              <div className={`absolute inset-0 bg-gradient-to-b ${card.bgGradient}`} />
        ...
        <div className="flex justify-center mt-12">
          <button
            className="py-3 px-10 bg-gray-800 hover:bg-black text-white font-semibold rounded-lg transition-all duration-300"
          >
            Explore All
          </button>
        </div>
