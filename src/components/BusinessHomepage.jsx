...
const IndustrialCards = () => {
  ...
  return (
    <div className="bg-[#EDF1F4] py-8 sm:py-12 px-4 sm:px-6 lg:px-8 font-sans">
      <div className="max-w-7xl mx-auto">
        {/* Title Section - Made consistent with the other component */}
        <div className="mb-10 lg:mb-12 px-4 sm:px-0">
