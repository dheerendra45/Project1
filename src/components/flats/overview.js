          ...
          >
            <div className="flex items-center mb-8">
              <h2 className="text-4xl font-bold text-gray-900">
                Flats / Patta: Premium-Grade SS Flats for Engineering & Fabrication
              </h2>
            ...
            <motion.p
              ...
              variants={fadeInUp}
            >
              Shyam Metalics produces precisely crafted steel flats (patta) in different grades and sizes, ideal for construction, fabrication, and industrial uses.
              <br /><br />
              We ensure our flats meet high quality standards through strict quality control, guaranteeing accurate dimensions and reliable mechanical performance.
            </motion.p>
