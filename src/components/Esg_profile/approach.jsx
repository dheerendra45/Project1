    ...
    <div className="text-black px-6 py-8 space-y-12">
      ...
      <ScrollReveal delay={2}>
        <div className="w-full px-8 text-left space-y-4 text-black">
          ...
          >
            {[
              "At Shyam Metalics, we invest in employee training,",
              "skill development, and green awareness programs",
              "to foster a culture of sustainability. Through",
              "workshops, certifications, the adoption of new",
              "technologies we empower our workforce to lead",
              "eco-friendly operations. Our corporate environmental",
              "policies align with global standards while promoting",
              "resource efficiency, waste reduction, and community",
