...
const Certificates = () => {
  ...
  const certificates = [
    { id: 1, title: "IS 2062 – Indian Standard for structural steel" },
    { id: 2, title: "ASTM A36 / AISI 1045 – International material standards" },
    { id: 3, title: "ISO 9001:2015 – Certified Quality Management System" },
  ];
