        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          >
            <div className="flex items-center mb-8">
              <h2 className="text-4xl font-bold text-gray-900">  SS Wire Rods</h2>
            ...
            <motion.p
              ...
              variants={fadeInUp}
            >
              Engineered for Strength, Durability & Versatility
              <br /><br />
              Our high-performance stainless steel wire is manufactured to meet the most stringent  international standards (ASTM, DIN, BS, JIS, NACE, AWS, GOST) and custom specifications. Designed for precision, strength, and longevity, these wires are ideal for industrial, construction, automotive,  and specialized applications.
              <br /><br />
            </motion.p>
